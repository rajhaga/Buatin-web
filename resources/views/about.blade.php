			...
			<div class="row align-items-center">
				<div class="col-lg-5" data-aos="fade-up" data-aos-delay="200" data-aos-duration="500">
					<div class="unique-solutions">
						...
						<p>BuatinKamu.Id adalah agen kreatif yang membantu Anda mewujudkan ide-ide promosi melalui layanan lengkap, seperti fotografi, videografi, pengelolaan media sosial, dan desain branding. Dengan dukungan dari Program Mahasiswa Wirausaha (PMW) oleh @cda.ipb, kami menyediakan solusi terbaik untuk bisnis Anda.</p>
						<div class="years-experience">
							<h3>1<sup>+</sup></h3>
							<h6>Tahun Pengalaman <br>Bekerja</h6>
						</div>
						<p class="pt-4">Thomas Walkar<br>Director of Creative Agency</p>
					</div>
				</div>
				<div class="col-lg-7" data-aos="fade-up" data-aos-delay="300" data-aos-duration="700">
					<div class="row">
						<div class="col-lg-6">
							<div class="services-style-one">
								...
								<p>Kami membantu bisnis Anda berkembang secara online dengan strategi pemasaran digital yang efektif, mulai dari iklan hingga pengelolaan konten media sosial.</p>
							</div>
						</div>
						<div class="col-lg-6">
							<div class="services-style-one">
								...
								<p>Produksi video kreatif dan berkualitas tinggi untuk berbagai kebutuhan pemasaran dan branding Anda, termasuk promosi produk dan profil perusahaan.</p>
							</div>
						</div>
						<div class="col-lg-6">
							<div class="services-style-one">
								...
								<h4><a href="#">Branding Design</a></h4>
								<p>Kami membantu menciptakan identitas visual yang kuat untuk merek Anda, mulai dari logo, desain kemasan, hingga materi promosi yang menarik.</p>
							</div>
						</div>
						<div class="col-lg-6">
							<div class="services-style-one">
								...
								<h4><a href="#">Poster Design</a></h4>
								<p>Membangun dan mengembangkan situs web yang responsif dan menarik untuk meningkatkan kehadiran online Anda .</p>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="planning-img-team">
					...
					<div class="planning-make about-make">
						  ...
						  <div>
							  ...
							  <p>Perencanaan yang detail dan strategis, memastikan setiap langkah kami terukur dan sesuai dengan kebutuhan Anda. Visi kami adalah memberikan hasil terbaik dengan pendekatan yang matang dan terstruktur.</p>
						  </div>
					  </div>
			</div>
			<div class="col-lg-4 col-md-6 p-0">
				...
				<div class="planning-make two about-make m-0">
					  ...
					  <div>
						  ...
						  <p>Merancang solusi kreatif yang fungsional dan estetis. Setiap desain yang kami buat memastikan proyek Anda tidak hanya terlihat menarik tetapi juga berjalan lancar dan efisien.</p>
					  </div>
				  </div>
			</div>
			<div class="col-lg-4 col-md-6 p-0">
				...
				<div class="planning-make three about-make m-0">
					  ...
					  <div>
						  ...
						  <p>Implementasi presisi tinggi. Tim kami bekerja keras untuk memastikan setiap detail eksekusi sesuai dengan rencana, sehingga proyek Anda terlaksana dengan sempurna, tepat waktu, dan sesuai harapan.</p>
					  </div>
				  </div>
			</div>
		</div>
